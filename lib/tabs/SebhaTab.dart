        ...
        children: [
          Expanded(
              ...
              child: GestureDetector(
                ...
                child: Image(
                  image: Theme.of(context).brightness == Brightness.light ? AssetImage("assets/images/sebha_img.png")
                      : AssetImage("assets/images/dark_sebha.png"),
                ),
              )),
          Container(
          ...
          Container(
              ...
              child: Text(
                "$numOfTasbeh",
                textAlign: TextAlign.center,
                style: Theme.of(context).brightness == Brightness.light ? Theme.of(context).textTheme.bodyMedium!.copyWith(color: Colors.white) :
